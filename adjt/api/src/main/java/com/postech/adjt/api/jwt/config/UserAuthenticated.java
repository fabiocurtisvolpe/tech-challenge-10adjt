...
public class UserAuthenticated implements UserDetails {
    ...
    /**
     * Instância da entidade {@link Usuario} que representa o usuário
     * autenticado.
     */
    ...
    public boolean isAccountNonLocked() {
        return this.usuario.getAtivo(); // Considera conta bloqueada se usuário estiver inativo
    }
    ...
    public boolean isEnabled() {
        return this.usuario.getAtivo(); // Usuário habilitado se estiver ativo
    }
}