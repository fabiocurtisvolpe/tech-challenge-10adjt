...
class AtualizarSenhaUsuarioUseCaseTest {
        ...
        void setUp() {
                ...
                usuarioExistente = UsuarioFactory.usuario(1, "João Silva", "joao@email.com", "senhaAntiga123",
                                tipoUsuarioValido, enderecos, true);
        ...
        void testAtualizarSenhaComSucesso() {
                // Arrange
                Usuario usuarioComSenhaAtualizada = UsuarioFactory.usuario(1, "João Silva", "joao@email.com",
                                "senhaCodificada456",
                                tipoUsuarioValido, enderecos, true);
        ...
        void testMantendoDadosAoAtualizarSenha() {
                // Arrange
                Usuario usuarioAtualizado = UsuarioFactory.usuario(1, "João Silva", "joao@email.com",
                                "senhaCodificada456",
                                tipoUsuarioValido, enderecos, true);
        ...
        void testAtualizarSenhaParaDiferentesUsuarios() {
                // Arrange
                Usuario usuario1 = UsuarioFactory.usuario(1, "João", "joao@email.com", "senhaAntigaJoao",
                                tipoUsuarioValido, enderecos, true);

                TipoUsuario tipoUsuarioFornecedor = TipoUsuarioFactory.tipoUsuario(2, "FORNECEDOR", "FORNECEDOR", true,
                                false);

                Usuario usuario2 = UsuarioFactory.usuario(2, "Maria", "maria@email.com", "senhaAntigaMaria",
                                tipoUsuarioFornecedor, new ArrayList<>(), true);

                Usuario usuario1Atualizado = UsuarioFactory.usuario(1, "João", "joao@email.com", "senhaNova123",
                                tipoUsuarioValido, new ArrayList<>(), true);

                Usuario usuario2Atualizado = UsuarioFactory.usuario(2, "Maria", "maria@email.com", "senhaNova456",
                                tipoUsuarioFornecedor, new ArrayList<>(), true);
                ...
                // Act
                TrocarSenhaUsuarioDTO dto1 = new TrocarSenhaUsuarioDTO("joao@email.com", "senhaAntigaJoao",
                                "senhaNova123");
                TrocarSenhaUsuarioDTO dto2 = new TrocarSenhaUsuarioDTO("maria@email.com", "senhaAntigaMaria",
                                "senhaNova456");
        ...
        void testMantendoUsuarioAtivoAposProcesso() {
                // Arrange
                Usuario usuarioAtualizado = UsuarioFactory.usuario(1, "João", "joao@email.com", "senhaCodificada456",
                                tipoUsuarioValido, enderecos, true);
        ...
        void testSequenciaDeChamsAoRepositorio() {
                // Arrange
                Usuario usuarioAtualizado = UsuarioFactory.usuario(
                                1,
                                "João Silva",
                                "joao@email.com",
                                "senhaCodificada456",
