...
public record AuthRequest(
                @Schema(description = "Login do usuário", example = "usuario", requiredMode = Schema.RequiredMode.REQUIRED) @JsonProperty("login") @NotNull(message = "Login não pode ser nulo") @NotBlank(message = "Login é obrigatório") @Size(min = 3, max = 50, message = "Login deve ter entre 3 e 50 caracteres") String login,
